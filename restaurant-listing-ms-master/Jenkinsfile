   ...
   stage('Check code coverage') {
            steps {
                script {
                    ...
                    def componentKey = "com.d3n15tec:restaurantlisting"
      ...
      steps {
          ...
          sh 'docker build -t denishpcinfo/restaurant-listing-service:${VERSION} .'
          sh 'docker push denishpcinfo/restaurant-listing-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: denishpcinfo\\/restaurant-listing-service:${VERSION}/" aws/restaurant-manifest.yml
        '''
